...
function Work({ element, workelement }) {
        ...
        <>
            <div className='tw-w-full'>
                ...
                <div className='tw-flex tw-justify-center   tw-w-full  tw-flex-wrap tw-gap-x-[90px] tw-gap-y-[40px] tw-mt-[3rem]'>
                    ...
                    {/* Experience Section */}
                    <motion.div className=' tw-space-y-[50px] tw-self-center tw-p-5 '
                    ...
                    >
                        ...
                        {/* Each Experience */}
                        {
                            workelement.map((element, indx) => {

                                return <div key={indx} className='tw-text-[18px] tw-flex tw-gap-x-[40px] tw-gap-y-2 tw-items-start tw-flex-wrap'>
                                    <h1 className='tw-text-[rgb(49,59,172)] tw-font-[800] tw-pt-1'>{element.year}</h1>
                                    <div className=''>
                                        <h2 className='tw-font-[500] tw-text-[16px] 2xs:tw-text-[19px]'>{element.works[0].company}</h2>
                                        <p className='tw-text-[13px] tw-font-[400] tw-text-[rgb(107,118,136)]'>{element.works[0].name}</p>
                                    </div>
                                </div>
                            })
