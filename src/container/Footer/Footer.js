...
function Footer() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const res = await emailjs.send('service_0afk5o9', 'contact_form', {
                my_name: 'Portfolio Owner',
                user_name: data.inquiry_name,
                user_email: data.your_email,
                message: data.your_message === null ? "No message send by the customer" : data.your_message
            })
            ...
            console.log(err);
            toast.success("Cannot send email", {
                id: "error-1"
            })
        }
        ...
        <>
            ...
            >
                ...
                <div className='tw-flex tw-justify-center tw-mt-[30px]  '>
                    <form ref={formid} className='tw-w-[510px lg:tw-min-w-[900px]  tw-w-[100%] tw-text-[#313bac] tw-flex tw-flex-col tw-gap-y-6 tw-px-3 text-sm::tw-px-0 ' onSubmit={handleSubmit(onSubmit)}>
                        <div className=''>
